...
class ByteBuddyProxyInvocation implements ProxyInvocation {
    ...
    private final static String NAME = "Screw";
    ...
    public static class ByteBuddyInterfaceMethodInterceptor {
        ...
        @RuntimeType
        public static Object intercept(@FieldValue("interceptor") InvocationInterceptor interceptor, @This Object proxy, @Origin Method method, @AllArguments Object[] args) throws InterruptedException {
            if (interceptor == null) {
                return null;
            }
    ...
    public static class ByteBuddyMethodInterceptor {
         ...
         */
        @RuntimeType
        public static Object intercept(@FieldValue("interceptor") InvocationInterceptor interceptor, @This Object proxy, @Origin Method method, @AllArguments Object[] args, @SuperCall Callable<?> callable) throws InterruptedException {
            if (interceptor == null) {
                return null;
            }
